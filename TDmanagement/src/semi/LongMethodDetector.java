 ...
 */
public class LongMethodDetector extends javax.swing.JFrame {
...
//        this.settingsMenu.setVisible(false); //FIXME: uncomment before final deliverable
    ...
    private void initComponents() {
        ...
        loadClassMenuItem = new javax.swing.JMenuItem();
        detectLongMethodsMenuItem = new javax.swing.JMenuItem();
        ...
        statusLabel.setText(" Select a class [File->Load class] to start the long method detection.");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Method name", "lcom2", "Needs refactoring"
            }
        ) {
        ...
        rankingMetricComboBox.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(identifyButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1018, Short.MAX_VALUE))
                        .addContainerGap())
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(rankingMetricComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(20, 20, 20))))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel2))
                .addGap(18, 18, 18)
                .addComponent(identifyButton, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(4, 4, 4))
        );
        ...
        loadClassMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                loadClassMenuItemActionPerformed(evt);
            }
        });
        fileMenu.add(loadClassMenuItem);

        detectLongMethodsMenuItem.setText("Detect long methods");
        detectLongMethodsMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                detectLongMethodsMenuItemActionPerformed(evt);
            }
        });
        fileMenu.add(detectLongMethodsMenuItem);
        ...
        jMenuItem1.setText("Ranking settigns");
        ...
        jMenuItem2.setText("Load premade opps");
    ...
    private void loadClassMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadClassMenuItemActionPerformed

        fc.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
        fc.setAcceptAllFileFilterUsed(false);
        FileFilter javaFilter = new FileNameExtensionFilter("Java files", new String[]{"Java", "java", "JAVA"});
        fc.addChoosableFileFilter(javaFilter);
        int returnVal = fc.showOpenDialog(this);
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            //delete old files if exist
            cleanFiles();
            java_source_file = fc.getSelectedFile();	//***POINT
            analyser = new Analyser();					//***POINT
            analyser.setFile(java_source_file);			//***POINT
            this.statusLabel.setText("Class " + java_source_file.getName() + " loaded.");
            task = new Task();	//***POINT ???
            task.execute();		//***POINT ???

        }
    }//GEN-LAST:event_loadClassMenuItemActionPerformed

    private void detectLongMethodsMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detectLongMethodsMenuItemActionPerformed
        task = new Task();	//***POINT
        task.execute();		//***POINT
    }//GEN-LAST:event_detectLongMethodsMenuItemActionPerformed

    private void identifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_identifyButtonActionPerformed
        MethodOppExtractor extractor = new MethodOppExtractor(java_source_file, selected_method, extractor_settings, clazz);//***POINT *GIA KATHE METHODO POU THA ANALUOUME
    ...
    private void rankingMetricComboBoxPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_rankingMetricComboBoxPropertyChange
        // TODO remove event handler        
    }//GEN-LAST:event_rankingMetricComboBoxPropertyChange

    private void rankingMetricComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rankingMetricComboBoxItemStateChanged
        try {
            performRanking();		//***POINT ???
        } catch (Exception ex) {
        }
    }//GEN-LAST:event_rankingMetricComboBoxItemStateChanged
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            //delete old files if exist
            cleanFiles();
            MethodOppExtractor methodExtractor = new MethodOppExtractor(fc.getSelectedFile(), extractor_settings);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LongMethodDetector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JMenuItem loadClassMenuItem;
    ...
    private DefaultTableModel populateTable() {		//***POINT *DIAVASMA
        ...
        //text allignment
        DefaultTableCellRenderer header_renderer = (DefaultTableCellRenderer) jTable1.getTableHeader().getDefaultRenderer();
        ...
        for (int index = 0; index < clazz.getMethods().size(); index++) {
            ...
            String value_for_table = String.valueOf(metric_value).equals("NaN") ? "NaN" : formatter.format((Number) metric_value);//***POINT
    ...
    private void cleanFiles() {
        try {
            File output = null;
            output = new File("clusters.txt");
            if (output.exists()) {
                output.delete();
            }

            output = new File(java_source_file.getName() + "_parsed.txt");
            if (output.exists()) {
                output.delete();
            }
        } catch (Exception ex) {
